...
urlpatterns = [
    ...
    re_path(r'^user_request_submit_url/$', views.UserRequestListSubmitView.as_view(), name="user_request_submit_url"),

   re_path(r'^user_request_list_url/$', views.UserRequestListView.as_view(), name="user_request_list_url"),
